...
public class ErrorHandlerFactoryBeanTest extends TestCase {

    protected ClassPathXmlApplicationContext ctx;

    public void setUp() throws Exception {
        ctx = new ClassPathXmlApplicationContext("org/apache/camel/spring/ErrorHandlerFactoryBean.xml");
    }
    ...
    public static class MyErrorProcessor implements Processor {
